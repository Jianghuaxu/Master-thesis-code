function [mobility,costs, Scheme_number_count] = simulate_simp(mobility, car_state, numTimesteps, Nx, Nx2, Ny, Ny2,paging_rate, TAL_scheme_num, history_length)
%
%
%
%
           ...
           %%                                            Part - Active UE
               ...
               % in active state, only handover would cause TAU
                ...
                if ~ ismember(mobility_current.TAI, mobility_last.TAL)
                    ...
                    [Type, N, direction_history] = TAL_optimisation_simp(mobility_temp, paging_rate, TAL_scheme, history_length);
