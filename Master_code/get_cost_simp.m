function Cost = get_cost_simp(lambda, my, sigma_tau, sigma_paging, n, type, six_directions, p_index)
...
if n>1
    P = getMarkovTransitionProbability_simp(n,type, six_directions, p_index, p_call);
